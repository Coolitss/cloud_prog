...
try {
    $user1 = $conn->prepare("SELECT * FROM user_patient WHERE user_id = ? ");
    $user1->execute([$user_id]);
    $userProfile = $user1->fetch(PDO::FETCH_ASSOC);
                    ...
                    <li class="nav-item dropdown pe-3">
                        ...
                        <ul class="dropdown-menu dropdown-menu-end dropdown-menu-arrow profile">
                            <li class="dropdown-header text-center">
                                ...
                                <span><?php echo ucwords(htmlspecialchars($userProfile['role'])) ?></span>
                            </li>
                            <li>
                                ...
                                <div class="card-body pt-4">
                                    <div class="d-flex flex-column align-items-center text-center">
                                        ...
                                        <div class="mt-3">
                                            ...
                                            <p class="text-secondary mb-1"><?php echo ucwords(htmlspecialchars($userProfile['role'])) ?></p>
