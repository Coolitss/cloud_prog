    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="dashboard.admin.php?page=clinic_management">Clinic Management</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="card h-100 w-100">
          <div class="card-header bg-primary text-white text-center">
            <h4 class="mb-0">Approve/Reject Registrations</h4>
          </div>
          <div class="card-body">
            <div class="pt-5 pb-2">
              <div class="d-flex justify-content-center align-items-center">
                <table class="table table-bordered">
                  ...
                  <?php if ($clinicData): ?>
                    <?php foreach ($clinicData as $index => $row): ?>
                      <tr>
                        <th><?php echo $index + 1; ?></th>
                        <td class="fw-bold"><?php echo htmlspecialchars($row['clinic_name']); ?></td>
                        ...
                        <td>
                          <div class="d-flex justify-content-center gap-1 flex-wrap">
                            <form action="../auth/admin_auth/update_clinic_status.php" method="POST">
                              <input type="hidden" name="clinic_id" value="<?php echo $row['clinic_id']; ?>">
                              <input type="hidden" name="status" value="approved">
                              <button type="submit" class="btn btn-success btn-sm w-auto">Approve</button>
                            </form>
                            ...
                            <form action="../auth/admin_auth/update_clinic_status.php" method="POST">
                              ...
                              <button type="submit" class="btn btn-danger btn-sm w-auto">Reject</button>
                            </form>
                          </div>
                        </td>
                      </tr>
                            ...
                            <div class="modal-body text-center">
                              <div class="row">
                                <div class="col-12 col-md-6">
                                  ...
                                  <img src="<?php echo '../uploads/' . htmlspecialchars($row['business_permit']); ?>" class="img-fluid rounded mb-2" alt="Business Permit">
                                </div>
                                <div class="col-12 col-md-6">
                                  <h6>Accreditation Certificate</h6>
                                  <img src="<?php echo '../uploads/' . htmlspecialchars($row['accreditation_certificate']); ?>" class="img-fluid rounded mb-2" alt="Accreditation Certificate">
                                </div>
                              </div>
                            </div>
                          </div>
            ...
            <div class="pt-5 pb-2">
              <div class="d-flex justify-content-center align-items-center">
                <table class="table table-bordered">
                  ...
                  <tbody>
                    <?php if ($overallClinicRetrieval): ?>
                      <?php foreach ($overallClinicRetrieval as $index => $row): ?>
                        <tr>
