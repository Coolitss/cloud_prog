  ...
  <main id="main" class="main">
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item"><a href="dashboard.admin.php?page=doctor_management">Doctor Management</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
    ...
    <section class="section dashboard">
      <div class="row">
        ...
        <div class="card h-100 w-100">
          <div class="card-header bg-primary text-white text-center">
            <h4 class="mb-0">Approve/Reject Doctor Registrations</h4>
          </div>
          <div class="card-body">
            <div class="pt-5 pb-2">
              <div class="d-flex justify-content-center align-items-center">
                <table class="table table-bordered">
                  ...
                  <?php if ($doctorData): ?>
                    <?php foreach ($doctorData as $index => $row): ?>
                      <tr>
                        ...
                        <td>
                          <div class="d-flex justify-content-center gap-1 flex-wrap">
                            <form action="../auth/admin_auth/update_doctor_status.php" method="POST">
                        ...
                        <div class="modal-dialog modal-dialog-centered">
                          <div class="modal-content">
                            ...
                            <div class="modal-body text-center">
                              <div class="row">
                                <div class="col-12">
                                  <h6>Professional License ID</h6>
                                  <img src="<?php echo 'uploads/' . htmlspecialchars($row['professional_license_id']); ?>" class="img-fluid rounded mb-2" alt="Professional License ID">
                                </div>
                              </div>
                            </div>
                          </div>
      ...
      <div class="row">
        ...
        <div class="card h-100 w-100">
          <div class="card-header bg-primary text-white text-center">
            <h4 class="mb-0">Overall Doctor Lists</h4>
          </div>
          <div class="card-body">
            <div class="pt-5 pb-2">
              <div class="d-flex justify-content-center align-items-center">
