    ...
    <div class="pagetitle">
      ...
      <nav>
        <ol class="breadcrumb">
          ...
          <li class="breadcrumb-item active"><a href="dashboard.admin.php">Dashboard</a></li>
        </ol>
      </nav>
    </div><!-- End Page Title -->
      ...
      <div class="row">
        ...
        <div class="col-lg-12">
          <div class="row w-100 justify-content-start flex-nowrap gap-3">
            ...
            <!-- Doctor Card -->
            <a href="doctor_side.admin.php" class="col-md-3 col-6">
            ...
            <!-- Patient Card -->
            <a href="patient_side.admin.php" class="col-md-3 col-6">
            ...
            <!-- Clinic Card -->
            <a href="clinic_side.admin.php" class="col-md-3 col-6">
