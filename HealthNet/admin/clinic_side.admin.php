        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="dashboard.admin.php?page=dashboard_main">Dashboard</a></li>
                    <li class="breadcrumb-item active">Clinic Lists</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if ($row["status"] === "approved") { ?>
                                                            <span class="text-success fw-bold"> <?php echo htmlspecialchars($row["status"]); ?> </span>
                                                        <?php } else if ($row["status"] === "pending") { ?>
                                                            <span class="text-warning fw-bold"> <?php echo htmlspecialchars($row["status"]); ?> </span>
                                                        <?php } else { ?>
                                                            <span class="text-danger fw-bold"> <?php echo htmlspecialchars($row["status"]); ?> </span>
                                                        <?php } ?>
                                                    </td>
                                                </tr>
                                            <?php endforeach; ?>
